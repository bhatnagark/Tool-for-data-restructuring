myfunction<-function(d,f1,f2,f3,f4,f5){
  ...
  #df_merged <- inner_join(data_1, data_2, by = 'Patient Id')
  ...
  # encounters_inline= merged_inline[,721:5102]
  ...
  # patients= encounters[encounters$"Patient Id"==1,]
  # patients1 = patients
  ...
  # colnames(encounters_inline[109])
  # patients[1, 5]
  # patients[1, 5+103*2]
  ...
  for(q in 1:682){
    ...
    for(j in 1:4437){
      ...
      for(m in 1:103){
        ...
        # if (ColName=="Date Of Visit" && j!=(103*n+1))
        #   print(j)
  ...
  # complications_inline= read.csv("searchResults-20180521_complications.csv", header = TRUE, check.names = F, as.is=TRUE)
  # complications_inline= 
  # complications_inlin<-complications_inline[-which(complications_inline$"Date of event"==""),]
